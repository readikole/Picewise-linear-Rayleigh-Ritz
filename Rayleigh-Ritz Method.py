...
for i in range(N-1):
    ...
    Q2.append(q2)
    q3 = (h[i])*(3*q(x[i]) + q(x[i+1]))
    Q3.append(q3)
    q4 = (h[i-1]/2)*(p(x[i]) + q(x[i-1]))
    Q4.append(q4)
...
q1n = (h[N-1]/12)*(p(x[N-1]) + q(x[N]))
Q1.append(q1n)
q2n = (h[N-1]/12)*(3*q(x[N]) + q(x[N-1]))
Q2.append(q2n)
q3n = (h[N-1])*(3*q(x[N-1]) + q(x[N]))
Q3.append(q3n)
q4n_last = (h[N]/2)*(p(x[N]) + q(x[N-1]))
q4n_second_last = (h[N-1]/2)*(p(x[N-1]) + q(x[N-2]))
Q4.append(q4n_second_last)
Q4.append(q4n_last)
q5n = (h[N-1]/6)*(2*rhs(x[N]) + rhs(x[N-1]))
Q5.append(q5n)
q6n = (h[N-1]/6)*(2*rhs(x[N-1]) + rhs(x[N]))
Q6.append(q6n)
